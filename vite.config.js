...
export default defineConfig({
  plugins: [react(), 
    VitePWA({
      ...
      //lo que se quiere guardar en la cache
      includeAssets: ['vite.svg', "public/android", "public/ios", "public/windows11"],
      manifest: {
        name: 'Contador React Vite PWA',
        short_name: 'Contador',
        description: 'React y Vite Contador con PWA',
        theme_color: '#ffffff',
        "icons": [
          {
